...
class ListviewPendingApproval extends StatelessWidget {
    ...
    return ListView.separated(
        itemBuilder: (context, index) {
          return ListTile(
            ...
            tileColor: tileColor,
            leading: const ShopImageListTile(),
            title: shopNameListTilePendingApprovals(context),
            subtitle: shopLocationPendingApprovals(context),
          );
        },
  ...
  shopLocationPendingApprovals(BuildContext context) {
  ...
  shopNameListTilePendingApprovals(BuildContext context) {
...
class ShopImageListTile extends StatelessWidget {
  const ShopImageListTile({
    super.key,
  });
